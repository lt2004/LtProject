...
+ (CLLocationCoordinate2D )AMapLocationFromBaiduLocation:(CLLocation *)BaiduLocation;
{
    ...
    CLLocationCoordinate2D AMapLocation = CLLocationCoordinate2DMake(AMapLatitude, AMapLongitude);
