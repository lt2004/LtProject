//
//  ChoicenessSelectMoreViewController.m
//  XTCAlbum
//
...
@interface ChoicenessSelectMoreViewController ()

@end

@implementation ChoicenessSelectMoreViewController
...
- (void)viewDidLoad {
    ...
    UIBezierPath *bezierPath = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 0, kScreenWidth, 290) byRoundingCorners:UIRectCornerTopLeft|UIRectCornerTopRight cornerRadii:CGSizeMake(10, 10)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        ...
        case 4: {
            ...
            cell.imageView.image = [UIImage imageNamed:@"modify_album_name"];
        }
            break;
        case 5: {
