...
- (void)applicationDidBecomeActiveNotification {
    // 播放音乐app切到小棠菜引起暂停问题
    if ([JPVideoPlayerManager sharedManager].videoPlayer.playerStatus == JPVideoPlayerStatusStop || [JPVideoPlayerManager sharedManager].videoPlayer.playerStatus == JPVideoPlayerStatusUnknown) {
        return;
    }
