...
//    if (expectOrientation == self.currentOrientation) {
//        return;
//    }
    if (expectOrientation == UIDeviceOrientationLandscapeLeft || expectOrientation == UIDeviceOrientationLandscapeRight || expectOrientation == UIDeviceOrientationPortrait) {
