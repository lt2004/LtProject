...
typedef NS_ENUM(NSUInteger, SourceHandleType) {
   SourceHandleDeleteType,
   SourceHandleMoveType,
   SourceHandleShareType,
   SourceHandleLockType,
};

typedef void(^SourceHandleCallBack)(SourceHandleType handleType);
...
@property (nonatomic, strong) SourceBottomHandleView *bottomHandleView;

@property (nonatomic, strong) SourceHandleCallBack sourceHandleCallBack;
