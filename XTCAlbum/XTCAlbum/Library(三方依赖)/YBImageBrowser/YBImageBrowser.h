...
typedef void(^HideBrowCallBack)(void);
typedef void(^DeleteSourceCallBack)(PHAsset * _Nullable deleteAsset);
typedef void(^DeletePrivateSourceCallBack)(NSString * _Nullable deletePrivateUrl);
...
@property (nonatomic, strong) HideBrowCallBack hideBrowCallBack;

@property (nonatomic, assign) BOOL isPrivateAlbum;
@property (nonatomic, strong) DeleteSourceCallBack deleteSourceCallBack;
@property (nonatomic, strong) DeletePrivateSourceCallBack deletePrivateSourceCallBack;
