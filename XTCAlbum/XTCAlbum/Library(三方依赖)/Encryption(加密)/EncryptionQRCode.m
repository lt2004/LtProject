...
@interface EncryptionQRCode() {
    
}

@end

@implementation EncryptionQRCode

//+ (NSString *) udid
//{
//    [[UIDevice currentDevice] un]
//    return [EncryptionQRCode encryptStr:[[UIDevice currentDevice] uniqueIdentifier]];
//}
...
{
    return [EncryptionQRCode doCipher:str key:_key context:kCCEncrypt];
}
+ (NSString *) decryptStr:(NSString    *) str
{
    return [EncryptionQRCode doCipher:str key:_key context:kCCDecrypt];
}
+ (NSString *)doCipher:(NSString *)sTextIn key:(NSString *)sKey
    ...
    if (encryptOrDecrypt == kCCDecrypt) {
        dTextIn = [[EncryptionQRCode decodeBase64WithString:sTextIn] mutableCopy];
    }
    else{
    ...
    if (encryptOrDecrypt == kCCDecrypt){
        ...
        sResult = [EncryptionQRCode encodeBase64WithData:dResult];
    }
    free(bufferPtr1);
    return sResult;
}
...
+ (NSString *)encodeBase64WithString:(NSString *)strData {
    return [EncryptionQRCode encodeBase64WithData:[strData dataUsingEncoding:NSUTF8StringEncoding]];
}
